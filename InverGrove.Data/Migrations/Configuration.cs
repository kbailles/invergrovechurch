...
namespace InverGrove.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<InverGroveContext>
    {
        ...
        protected override void Seed(InverGroveContext context)
        {
            ...
            context.People.AddOrUpdate(p => new { p.FirstName, p.LastName }, keenanPerson);
            context.SaveChanges();
            ...
            context.PhoneNumbers.AddOrUpdate(p => new { p.PersonId, p.PhoneNumberTypeId }, keenanPhoneNumber);
            context.SaveChanges();
